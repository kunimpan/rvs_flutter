...
class StatusSuccessScreen extends StatefulWidget {
  const StatusSuccessScreen({Key? key}) : super(key: key);

  @override
  _StatusSuccessScreenState createState() => _StatusSuccessScreenState();
}

class _StatusSuccessScreenState extends State<StatusSuccessScreen> {
